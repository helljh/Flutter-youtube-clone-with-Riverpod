...
import '../../../upload/long_video/video_repository.dart';
...
class _VideoState extends ConsumerState<Video> {
  ...
  likeVideo() async {
    ...
    if (widget.video.likes.contains(currentUserId)) {
            ...
            Padding(
              ...
              child: GestureDetector(
                ...
                child: Container(
                    ...
                    child: comments.value!.isNotEmpty
                        ? VideoFirstComment(
